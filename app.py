...
page_df["high_severity_probability"] = (page_df["high_severity_probability"] * 100).round(1)
page_df["high_severity_flag"] = page_df["high_severity_flag"].map({True: "🔴 YES", False: "—"})
...
st.dataframe(
    ...
    column_config={
        ...
        "high_severity_flag": st.column_config.TextColumn(
            "Flagged",
